...
from Inversion.Inversion1D import inverse_universal
...
def main(input_folder, dx, nx, use_rays_p, use_rays_s,
    ...
    forward_input_params = {
        ...
        'display_stat': False,
        'visualize_res': False,
        'calc_reflection_p': use_reflection_p,
        'calc_reflection_s': use_reflection_s
    }
...
if __name__ == '__main__':
    ...
    main(input_folder, dx, nx, use_rays_p, use_rays_s, use_reflection_p, use_reflection_s)
