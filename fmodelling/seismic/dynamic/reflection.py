...
from fmodelling.seismic.dynamic.zoeppritz_coeffs import pdownpup, svdownsvup, pdownsvup
...
def calculate_reflections_vectorized(model, rays, element):
    ...
    if element == OWT.PdPu:
        ...
        reflection_amplitudes = np.concatenate((reflection_amplitudes_bottom, reflection_amplitudes_undbottom))
