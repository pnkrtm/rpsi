import numpy as np
from fmodelling.seismic.dynamic.zoeppritz_coeffs import pdownpdown, puppup, svdownsvdown, svupsvup
from fmodelling.seismic.dynamic.zoeppritz_coeffs_water import pdownpdown_water as pdpd_sea, puppup_water as pupu_sea
