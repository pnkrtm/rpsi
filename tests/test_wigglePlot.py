...
if __name__ == '__main__':
    segy_file_1 = "../work_models_v2/perlayer_models/model_2layered/input/pwaves.sgy"
    seismogram_1 = read_segy(segy_file_1)
    data_1 = seismogram_1.get_values_matrix()
    data_1 = np.array([d / max(abs(d)) for d in data_1])

    segy_file_2 = "../work_models_v2/perlayer_models/model_3layered/input/pwaves.sgy"
    seismogram_2 = read_segy(segy_file_2)
    data_2 = seismogram_2.get_values_matrix()
    data_2 = np.array([d / max(abs(d)) for d in data_2])

    wiggle(data_1.T)
    wiggle(data_2.T, color='b')
